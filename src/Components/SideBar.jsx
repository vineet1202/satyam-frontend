...
const SideBar = ({ links, navState: navExtState, navStateToggleHandler: handleNavExtStateToggle }) => {
  ...
  return (
    <FlexCol
      as="aside"
      className={`${navExtState === "open" && "animate-[slideRight_.3s_ease-out_forwards] shadow-[1px_0_10px_1000px_rgba(13,11,14,.3)]"} fixed -left-full z-20 min-h-screen max-w-fit gap-12 bg-white  px-7 pb-12 pt-6 transition-all md:relative  md:left-auto md:animate-none md:border-r-[1px]  md:border-r-gray-300   `}>
      <div
      ...
      {/* <LinkElement className="justify-self-end" key={'/satyam/settings'}></LinkElement> */}
    </FlexCol>
  );
};
